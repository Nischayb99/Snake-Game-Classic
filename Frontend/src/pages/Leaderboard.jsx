                    ...
                    >
                      ...
                      >
                        <img
                          ...
                          alt={player.name}
                          className="w-12 h-12 rounded-full border-2 border-gray-600 object-cover cursor-pointer hover:border-green-400"
                          onError={(e) => {
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => openUserProfile(player._id)}
                            className="text-white font-semibold hover:text-green-400 transition-colors cursor-pointer text-left"
                          >
                            {player.name}
                            {isCurrentUser && (
                        ...
                        <button
                          onClick={() => openUserProfile(player._id)}
                          className="text-gray-400 text-sm hover:text-green-400 transition-colors cursor-pointer"
                        >
                          @{player.username}
                        </button>
                      </div>
